...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/../../gbkyc-module/.ios/.symlinks/plugins/gbkyc/ios/FaceTecSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/gbkyc/gbkyc.framework"
  install_framework "${PODS_ROOT}/../../gbkyc-module/.ios/Flutter/App.framework"
